# Text Mining 2025/26
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/bloemj/AUC_TM_2026/main)

Amsterdam University College -- Text Mining -- Spring 2026.
...
| 3      | Language modelling  | <a href='slides/AUC_3_language_models_2026.pdf'>slides</a> + notebooks <a href='notebooks/3_Distributions_in_text.ipynb'>1</a>, <a href='notebooks/3_WordNet.ipynb'>2</a>, <a href='https://www.kaggle.com/code/alvations/n-gram-language-model-with-nltk'>N-gram LM</a> (external) |
| 4      | Vector space semantics | <a href='slides/AUC_4_vectorSpaceSemantics_2026.pdf'>slides</a> + <a href='notebooks/4_Vector_Semantics.ipynb'>notebook</a> |
| 5      | Word embeddings | <a href='AUC_5_Word_Embeddings_2026.pdf'>slides</a> + <a href='notebooks/5_WordEmbeddings.ipynb'>notebook</a> |
...
| 10      | Sentiment analysis  | slides + <a href='notebooks/11_Sentiment_Analysis.ipynb'>notebook</a> |
| 11      | Clustering and topic modelling  | slides + <a href='notebooks/12_Clustering_TopicModelling.ipynb'>notebook</a> |
...
Projects will start in the second half of the course!

## Set-up

### Running in the cloud (Google Colab)

1. Fork the repository to your Github account: go to https://github.com/bloemj/AUC_TM_2026 and click Fork
...
1. Clone the repository locally: `git clone git@github.com:bloemj/AUC_TM_2026.git`. Alternatively, clone your own fork of the repository locally.
...
5. Create a conda environment: `conda create -n myenv python=3.12 anaconda` (where `myenv` is the envirnoment name)
